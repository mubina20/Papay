class Definer {
    // bu ERRORlarni ko'p joyda ishlatkanimiz uchun - alohida fileda Definer classini hosil qilib oldik, keragini olib ishlataveramiz
    ...
    // Member Authentication bilan bog'liq xatolar
    ...
    // Product Authentication bilan bog'liq xatolar
    static product_err1 = "att: product hosil qilishda xatolik bo'ldi!";

    // Buyurtmalar bilan bog'liq xatolar
    static order_err1 = "att: buyurtma yasashda xatolik bo'ldi!";
	static order_err2 = "att: buyurtma elementi yasab bo'lmadi!";
	static order_err3 = "att: bu parametrlar bilan hech qanday tartib mavjud emas!";

	// Maqolalar bilan bog'liq xatolar 
    ...
    // Obuna(follow)ga bog'liq xatolar
    static follow_err1 = "att: o'z-o'zidan obuna rad etildi!";
